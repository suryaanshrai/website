    ...
    <div class="about-hero">
      <div class="about-hero-main">
        ...
        <p class="about-body">
          ...
          father teaches geography at Sainik School Ambikapur, and hence my abode. My mother is
          also a teacher at Holy Cross Senior Secondary School Ambikapur; quite a long name but a
          good school.
        </p>
        <p class="about-body">
